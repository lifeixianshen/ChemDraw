...
class Ui_ChemDraw(object):
    def setupUi(self, ChemDraw):
        ...
        self.verticalLayout.addWidget(self.pfdenv)
        ...
        self.verticalLayout.addWidget(self.Icon_window)
    ...
    def retranslateUi(self, ChemDraw):
        ...
        self.status_lable.setText(_translate("ChemDraw", "          "))
        self.status_label_2.setText(_translate("ChemDraw", "                 "))
