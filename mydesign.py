...
class Ui_ChemDraw(object):
    def setupUi(self, ChemDraw):
        ...
        self.pfdenv = QtWidgets.QGraphicsView(self.frame)
        ...
        self.pfdenv.setMouseTracking(False)
        self.pfdenv.setTabletTracking(False)
        ...
        self.pfdenv.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        ...
        self.horizontalLayout_2.addWidget(self.pfdenv)
        ...
        self.Icon_window.setMinimumSize(QtCore.QSize(377, 200))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/Cooler.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_cooler.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/Heater.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_heater.setIcon(icon2)
        ...
        self.gridLayout_4.addWidget(self.Icon_window, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.log_window, 2, 0, 1, 1)
        ...
        self.status_label_3.setTextFormat(QtCore.Qt.RichText)
        self.status_label_3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.status_label_3.setObjectName("status_label_3")
        self.horizontalLayout.addWidget(self.status_label_3)
    ...
    def retranslateUi(self, ChemDraw):
        ...
        self.status_label_3.setText(_translate("ChemDraw", "<html><head/><body><p><span style=\" font-weight:600; color:#bc13ff;\">ChemDraw  </span></p></body></html>"))
